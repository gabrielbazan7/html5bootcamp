...
(function() {
 ...
 $(document).ready(function() {
  ...
  var movie1=new Movie({title:'terminator the movie',year:'1995'});
  var movie2=new Movie({title:'rocky',year:'1990'});
  var movie3=new Movie({title:'horns',year:'2010'});
  var movie4=new Movie({title:'big hero 6',year:'2014'});
